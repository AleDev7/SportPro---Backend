...
public class SocioService implements Service<Socio> {
    ...
    private List<Socio> list; //El servicio es el encargado de manipular a todos los socios por eso tiene la lista
    private final String fileName;

    //Constructor por defecto
    public SocioService() throws Exception {
        fileName = Utils.getConfig().getJSONObject("archivos").getString("socios");
    ...
    public JSONObject remove(String id) throws Exception {
        ...
        String alquileres = Utils.getConfig().getJSONObject("archivos").getString("alquileres");
    ...
    public Socio getUpdated(JSONObject newData, Socio current) {
        ...
        // actualizar con los valores del socio con los valores recibido como primer argumento
